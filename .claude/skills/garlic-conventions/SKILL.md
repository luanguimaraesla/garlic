...
Release-specific migrations belong to the generated GitHub release notes and
are handled by `garlic-update`; this skill documents steady-state behavior only.
