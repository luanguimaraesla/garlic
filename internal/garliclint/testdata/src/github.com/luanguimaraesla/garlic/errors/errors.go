...
func (*TemplateT) Propagate(error, ...Opt) error { return &ErrorT{} }

func Propagate(error, string, ...Opt) error          { return &ErrorT{} }
func PropagateAs(*Kind, error, string, ...Opt) error { return &ErrorT{} }
func New(*Kind, string, ...Opt) *ErrorT              { return &ErrorT{} }
func Raw(*Kind, string, ...Opt) *ErrorT              { return &ErrorT{} }
func From(*Kind, error, string, ...Opt) error        { return &ErrorT{} }
